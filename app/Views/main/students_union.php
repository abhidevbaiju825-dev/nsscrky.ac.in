...
<div class="max-w-screen-xl mx-auto px-4 py-12">
  <div class="grid lg:grid-cols-4 gap-10">
    ...
    <div class="lg:col-span-3 space-y-12">
      ...
      <!-- About Section -->
      <div style="background:#fff;border-radius:14px;padding:32px;box-shadow:0 2px 15px rgba(0,0,0,0.05);border:1px solid #eee;">
        ...
        <?php if(!empty($union_activities_lst)): ?>
          ...
          <div style="line-height:1.8;color:#444;font-size:16px;text-align:justify;margin-bottom:15px;">
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-3">
          ...
          <div style="display:flex;align-items:center;padding:0 24px 8px;border-bottom:2px solid #eee;margin-bottom:10px;">
          ...
          ?>
            <?php if($isChair): ?>
              ...
              <div style="background:linear-gradient(135deg,#0d2448 0%,#071530 100%);border-radius:12px;padding:20px 24px;display:flex;align-items:center;justify-content:space-between;box-shadow:0 8px 25px rgba(13,36,72,0.15);position:relative;overflow:hidden;margin-top:10px;margin-bottom:10px;">
                <!-- Decorative elements -->
                ...
                <div style="display:flex;align-items:center;position:relative;z-index:1;width:100%;">
            ...
            <?php else: ?>
              <!-- Regular List Item for Others -->
              <div style="background:#fff;border-radius:12px;padding:16px 24px;display:flex;align-items:center;justify-content:space-between;border:1px solid #eee;transition:all 0.2s;" onmouseover="this.style.background='#fcfcfc'" onmouseout="this.style.background='#fff'">
                <div style="flex:1;display:flex;align-items:center;">
    ...
    <div>
      ...
      <!-- Quick Contact / Info (Optional extra sidebar item) -->
      <div style="background:#fff;border-radius:14px;padding:20px;box-shadow:0 2px 12px rgba(0,0,0,0.05);border:1px solid #eee;">
        ...
        <div style="font-size:13px;color:#555;display:flex;align-items:flex-start;margin-bottom:10px;">
          <i class="bi bi-geo-alt-fill text-yellow-600 mt-0.5 mr-2"></i>
          <span>Students Union Room,<br>Main Block, Ground Floor</span>
        </div>
        <div style="font-size:13px;color:#555;display:flex;align-items:center;margin-bottom:10px;">
          <i class="bi bi-envelope-fill text-yellow-600 mr-2"></i>
          <span>union@nsscrky.ac.in</span>
        </div>
      </div>
